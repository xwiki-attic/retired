...
public abstract class IndexFields
{
    ...
    /**
     * Time at which document has been indexed.
     */ 
    ...
    /**
     * Hostname(IP) address of the machine on which XWiki is installed. 
     */
    public static final String HOSTNAME = "hostname";

    /**
     * Port on which Servlet Container like Jetty/Tomcat is running.
     */
