...
public class SearchResults extends Api
{
	...
	config = context.getWiki().getConfig();
        this.hostname=config.getProperty(DEFAULT_HOSTNAME, "127.0.0.1");
    }
                ...
                for (int i = 0; i < hitcount; i++) {
                    ...
                    try {
                        ...
                        if ( (result != null && result.isWikiContent()
                            && xwiki.checkAccess(pageName, "view") && xwiki.exists(pageName)) || !this.hostname.equals(result.getHostname()) ) {
                ...
                for (int i = 0; i < hitcount; i++) {
                    ...
                    try {
                        ...
                        if ( (result != null && result.isWikiContent() && xwiki.exists(pageName)
                            && xwiki.checkAccess(pageName, "view")) || !this.hostname.equals(result.getHostname()) ) {
