...
public class IndexSearchServer extends Thread
{
	...
	Naming.rebind("//"+this.hostname+":"+this.port+"/XWiki_LuceneMultiSearch",this.multiImpl);

	System.out.println("Lucene Search Server started");
	}
	catch(Exception e){
   ...
   */
   public void resetServer()
   {
	...
	this.multiImpl.close();
      ...
      Naming.rebind("//"+this.hostname+":"+this.port+"/XWiki_LuceneMultiSearch",multiImpl);
