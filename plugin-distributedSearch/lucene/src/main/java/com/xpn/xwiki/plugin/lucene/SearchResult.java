...
public class SearchResult
{
	...
	this.hostname = doc.get(IndexFields.HOSTNAME);
	this.servletPort = doc.get(IndexFields.SERVLET_PORT);
    ...
    /**
     * @return Returns the hostname the server to which document belongs to.
     */
    ...
    /**
     * @return Returns the Servlet port of the server to which document belongs to.
     */
