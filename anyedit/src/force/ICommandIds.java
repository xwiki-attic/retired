...
public interface ICommandIds {
	...
	public static final String CMD_OPEN = "force.open";

	public static final String CMD_OPEN_MESSAGE = "force.openMessage";

	//public static final String CMD_CONNECT = "force.connect";
