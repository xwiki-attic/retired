...
public class InitFactoryTest extends TestCase {
	...
	protected void setUp() throws Exception {
		this.builder = new XWTBuilder(getClass().getClassLoader(),
			getClass().getResourceAsStream("InitFactoryTest.map"));
	}

	public void testTextFactory() throws Exception {
		InputStream stream = getClass().getResourceAsStream("InitFactoryTest-1.xml");
