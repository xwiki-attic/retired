    ...
    private IEventListener fListener = new EventListener() {
        ...
        public void handleEvent(Event event) {
            ...
            if (fCurrentAnnotation == null) {
                if (e.stage == OnEditEvent.BEGIN) {
                    ...
                    FieldPanelUtil.setFieldValues(fForm, fCurrentAnnotation
                        .getProperties());
                ...
                FieldPanelUtil.updateFieldValues(fForm, fCurrentAnnotation
                    .getProperties());
            }
        }
        ...
        public boolean prepareEvent(Event event) {
            ...
            if (fCurrentAnnotation != null && OnEditEvent.SAVE == e.stage) {
                IPropertiesContainer properties = FieldPanelUtil
                    .getFieldValues(fForm);
    ...
    private ClickListener newClickListener(final int eventType) {
        return new ClickListener() {
            public void onClick(Widget sender) {
                if (fCurrentAnnotation != null) {
                    fModel.fireEvent(new OnEditEvent(
                        fCurrentAnnotation,
                        eventType));
                }
            }
