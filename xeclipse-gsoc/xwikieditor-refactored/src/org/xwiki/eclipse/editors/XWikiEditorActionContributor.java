...
public class XWikiEditorActionContributor extends TextEditorActionContributor
{
    ...
    public XWikiEditorActionContributor()
    {
        ...
        contentAssistProposal =
            new RetargetTextEditorAction(Activator.getDefault().getResourceBundle(), "ContentAssistProposal.");

        editorInfoAction = new RetargetTextEditorAction(Activator.getDefault().getResourceBundle(), "EditorInfo.");
    }
