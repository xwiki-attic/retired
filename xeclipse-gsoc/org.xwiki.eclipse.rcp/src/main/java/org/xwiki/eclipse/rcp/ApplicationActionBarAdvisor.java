...
public class ApplicationActionBarAdvisor extends ActionBarAdvisor {
	...
	protected void makeActions(IWorkbenchWindow window) {
		...
		IWorkbenchAction showViewMenuAction = ActionFactory.SHOW_VIEW_MENU
				.create(window);
		register(showViewMenuAction);

		showViewActions = new ArrayList<Action>();

		for (IViewDescriptor v : window.getWorkbench().getViewRegistry()
				.getViews()) {
	...
	protected void fillMenuBar(IMenuManager menuBar) {
		...
		MenuManager showViewMenu = new MenuManager("Show view",
				"org.xwiki.xeclipse.menu.ShowView");
