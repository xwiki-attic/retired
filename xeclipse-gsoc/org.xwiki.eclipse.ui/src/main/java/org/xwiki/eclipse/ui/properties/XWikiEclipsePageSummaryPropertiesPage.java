...
public class XWikiEclipsePageSummaryPropertiesPage extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		XWikiEclipsePageSummary pageSummary = (XWikiEclipsePageSummary) getElement()
				.getAdapter(XWikiEclipsePageSummary.class);

		Label property = new Label(composite, SWT.NONE);
		property.setText("Id:");
		Label value = new Label(composite, SWT.NONE);
		value.setText(pageSummary.getData().getId() == null ? "" : pageSummary
				.getData().getId());

		property = new Label(composite, SWT.NONE);
		property.setText("Title:");
		value = new Label(composite, SWT.NONE);
		value.setText(pageSummary.getData().getTitle() == null ? ""
				: pageSummary.getData().getTitle());

		property = new Label(composite, SWT.NONE);
		property.setText("Parent:");
		value = new Label(composite, SWT.NONE);
		value.setText(pageSummary.getData().getParentId() == null ? ""
				: pageSummary.getData().getParentId());

		property = new Label(composite, SWT.NONE);
		property.setText("Space:");
		value = new Label(composite, SWT.NONE);
		value.setText(pageSummary.getData().getSpace() == null ? ""
		...
		link.setText(pageSummary.getData().getUrl() == null ? "" : String
				.format("<a>%s</a>", pageSummary.getData().getUrl()));
