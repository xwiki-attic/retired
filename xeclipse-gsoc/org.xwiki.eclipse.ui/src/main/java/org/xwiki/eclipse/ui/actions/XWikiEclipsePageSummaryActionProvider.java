...
public class XWikiEclipsePageSummaryActionProvider extends CommonActionProvider {
	...
	public void init(final ICommonActionExtensionSite aSite) {
		open = new OpenXWikiModelObjectAction(aSite.getViewSite()
		...
		newObject = new CommandContributionItem(PlatformUI.getWorkbench(),
				null, UIConstants.NEW_OBJECT_COMMAND, null, null, null, null,
				null, null, null, SWT.NONE);

		renamePage = new CommandContributionItem(PlatformUI.getWorkbench(),
				null, UIConstants.RENAME_PAGE_COMMAND, null, null, null, null,
				null, null, null, SWT.NONE);
