...
public class DataManagerActionProvider extends CommonActionProvider {
	...
	public void init(final ICommonActionExtensionSite aSite) {
		...
		connect = new CommandContributionItem(PlatformUI.getWorkbench(), null,
				UIConstants.DATA_MANAGER_CONNECT_COMMAND, null, null, null,
		...
		disconnect = new CommandContributionItem(PlatformUI.getWorkbench(),
				null, UIConstants.DATA_MANAGER_DISCONNECT_COMMAND, null, null,
		...
		newPage = new CommandContributionItem(PlatformUI.getWorkbench(), null,
				UIConstants.NEW_PAGE_COMMAND, null, null, null, null, null,
				null, null, SWT.NONE);
