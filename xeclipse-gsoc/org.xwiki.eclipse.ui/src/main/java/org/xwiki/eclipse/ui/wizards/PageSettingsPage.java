...
public class PageSettingsPage extends WizardPage {
	...
	public PageSettingsPage(String pageName) {
		...
		setImageDescriptor(UIPlugin
				.getImageDescriptor(UIConstants.SPACE_SETTINGS_BANNER));
	}
	...
	public void createControl(Composite parent) {
		...
		newPageWizardState = ((NewPageWizard) getWizard())
				.getNewPageWizardState();
	...
	public boolean isPageComplete() {
		if ((spaceText.getText() == null)
				|| (spaceText.getText().length() == 0)) {
