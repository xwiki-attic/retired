...
public class XWikiEclipseSpaceSummaryPropertiesPage extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		XWikiEclipseSpaceSummary spaceSummary = (XWikiEclipseSpaceSummary) getElement()
				.getAdapter(XWikiEclipseSpaceSummary.class);

		Label property = new Label(composite, SWT.NONE);
		property.setText("Key:");
		Label value = new Label(composite, SWT.NONE);
		value.setText(spaceSummary.getData().getKey() == null ? ""
				: spaceSummary.getData().getKey());

		property = new Label(composite, SWT.NONE);
		property.setText("Name:");
		value = new Label(composite, SWT.NONE);
		value.setText(spaceSummary.getData().getName() == null ? ""
				: spaceSummary.getData().getName());

		property = new Label(composite, SWT.NONE);
		property.setText("Url:");
		Link link = new Link(composite, SWT.NONE);
		link.setText(spaceSummary.getData().getUrl() == null ? "" : String
				.format("<a>%s</a>", spaceSummary.getData().getUrl()));
