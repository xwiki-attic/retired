...
public class RefreshActionProvider extends CommonActionProvider {
	...
	public void init(final ICommonActionExtensionSite aSite) {
		...
		/*
		 * This is the preferred way for creating a command contribution item in
		 * Eclipse 3.4
		 */
		...
		refresh = new CommandContributionItem(PlatformUI.getWorkbench(), null,
				UIConstants.REFRESH_COMMAND, null, null, null, null, null,
				null, null, SWT.NONE);
