...
public class PageDocumentProvider extends FileDocumentProvider
{
    ...
    {
        //Now the document partitioning logic is happening inside this method
        if (element instanceof PageEditorInput) {
            ...
            IDocumentPartitioner partitioner =
                new XWikiPartitioner(new DocumentPartitionScanner(),DocumentPartitionScanner.XWIKI_PARTITION_TYPES);
