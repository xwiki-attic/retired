...
import org.xwiki.eclipse.ui.editors.scanners.detectors.DlWordDetector;
...
public class DlScanner extends RuleBasedScanner
{

    @SuppressWarnings("unchecked")
    public DlScanner(ColorProvider provider)
    {
        ...
        WordRule wordRule = new WordRule(new DlWordDetector(), xwiki_code);
        rules.add(wordRule);
