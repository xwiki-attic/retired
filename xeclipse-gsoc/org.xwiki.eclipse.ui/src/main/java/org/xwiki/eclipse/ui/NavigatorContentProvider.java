...
public class NavigatorContentProvider extends BaseWorkbenchContentProvider
		...
		NotificationManager.getDefault()
				.addListener(
						...
						new CoreEvent.Type[] {
								...
								CoreEvent.Type.DATA_MANAGER_CONNECTED,
	...
	public Object[] getChildren(Object element) {
		/*
		 * If our parent is a project then return the data manager associated to
		 * that project
		 */
		if (element instanceof IProject) {
			IProject project = (IProject) element;
			DataManager dataManager = DataManagerRegistry.getDefault()
					.findDataManagerByProject(project);
			if (dataManager != null)
	...
	public Object[] getElements(Object element) {
		Object[] result = DataManagerRegistry.getDefault().getDataManagers()
				.toArray();
		return filterByWorkingSet(result, workingSet);
	}
	...
	private Object[] filterByWorkingSet(Object[] objects, IWorkingSet workingSet) {
		...
		for (Object object : objects) {
			if (object instanceof DataManager) {
				...
				if (UIUtils.isXWikiEcipseIdInWorkingSet(dataManager
						.getXWikiEclipseId(), workingSet))
					result.add(object);
			}

			if (object instanceof ModelObject) {
				ModelObject modelObject = (ModelObject) object;
				if (UIUtils.isXWikiEcipseIdInWorkingSet(modelObject
						.getXWikiEclipseId(), workingSet))
					result.add(object);
			}
		}
