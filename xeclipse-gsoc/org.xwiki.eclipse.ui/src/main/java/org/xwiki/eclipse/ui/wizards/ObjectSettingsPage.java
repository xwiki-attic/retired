...
public class ObjectSettingsPage extends WizardPage {
	...
	public ObjectSettingsPage(String pageName, DataManager dataManager) {
		...
		setImageDescriptor(UIPlugin
				.getImageDescriptor(UIConstants.OBJECT_SETTINGS_BANNER));
	...
	public void createControl(Composite parent) {
		...
		newObjectWizardState = ((NewObjectWizard) getWizard())
				.getNewObjectWizardState();
		...
		final XWikiEclipseSafeRunnableWithResult<List<XWikiEclipseClassSummary>> runnable = new XWikiEclipseSafeRunnableWithResult<List<XWikiEclipseClassSummary>>() {
		...
		combo.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				newObjectWizardState.setClassName(combo.getItem(combo
						.getSelectionIndex()));
