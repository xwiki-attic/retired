...
/**
 * This is a property tester for the Eclipse Core Expression framework for
 * building expression containing conditions about data managers. It is used in
 * declarative handler definitions for activating/de-activating handlers.
 * 
 * @author fmancinelli
 */
