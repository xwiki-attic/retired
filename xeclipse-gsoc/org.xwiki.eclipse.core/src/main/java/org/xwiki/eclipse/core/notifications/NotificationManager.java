...
/**
 * A singleton implementing a notification manager. XWiki Core classes should
 * use this singleton for publishing events.
 * 
 * @author fmancinelli
 */
public class NotificationManager {
	...
	/**
	 * A private class that contains information about a listener and the even
	 * type it is interested in.
	 * 
	 * @author fmancinelli
	 */
	static private class ListenerEntry {
		...
		public ListenerEntry(ICoreEventListener listener,
				CoreEvent.Type[] eventTypes) {
	 ...
	 *            The listener.
	 * @param eventTypes
	 *            An array containing the event types the listener is interested
	 *            in.
	 * @see CoreEvent.Type
	 */
	public void addListener(ICoreEventListener listener,
			CoreEvent.Type[] eventTypes) {
