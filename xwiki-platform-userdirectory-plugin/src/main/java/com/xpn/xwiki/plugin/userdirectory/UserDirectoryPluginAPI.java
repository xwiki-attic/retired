...
public class UserDirectoryPluginAPI extends Api
{
    ...
    public boolean addParentGroup(String childGroupName, String parentGroupName, XWikiContext context) throws
            XWikiException
    {
        return userDir.addParentGroup(childGroupName, parentGroupName, context);
    }

    public boolean removeParentGroup(String childGroupName, String parentGroupName, XWikiContext context) throws
            XWikiException
    {
    ...
    public String inviteToGroup(String name, String firstName, String email, String group, XWikiContext context) throws
            XWikiException
    {
