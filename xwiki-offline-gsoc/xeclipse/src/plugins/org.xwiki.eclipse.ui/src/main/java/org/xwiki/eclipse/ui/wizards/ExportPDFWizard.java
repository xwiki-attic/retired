...
import org.xwiki.eclipse.ui.wizards.pages.PDFSettingsPage;

/**
 * @author Eduard Moraru
 *
 */
public class ExportPDFWizard extends AbstractExportWizard
{
    public ExportPDFWizard()
    {
        ...
        setFormat("pdf");
        setExtension("pdf");
        setExpectedContentType("application/pdf");
    }
    ...
    {
        addPage(new PDFSettingsPage("PDF Settings"));
    }
