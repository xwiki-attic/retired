...
public class DefaultActivityBuilder extends AbstractActivityBuilder implements ActivityBuilder
{
    ...
    {
        ActivityEvent activityEvent = prepareActivity(streamName, applicationName, newdoc, olddoc, context);
        List<String> params = new ArrayList<String>();
        String title = "xws.activities." + applicationName.toLowerCase() + "." + activityEvent.getType();
     ...
     * {@inheritDoc}
     */
    protected String getDocumentTitle(XWikiDocument newdoc, XWikiDocument olddoc, XWikiContext context)
    {
