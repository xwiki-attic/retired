...
public class PhotosApplicationActivityBuilder extends DefaultActivityBuilder
{
    ...
    /**
     * The name of the document holding the class definition of a photo gallery.
     */
    private static final String XWS_PHOTOGALLERY_CLASS = "XWSCode.PhotoGalleryClass";
    ...
    {
        if (olddoc.getObject(XWS_PHOTOGALLERY_CLASS, false, context) == null
            && newdoc.getObject(XWS_PHOTOGALLERY_CLASS, false, context) == null) {
