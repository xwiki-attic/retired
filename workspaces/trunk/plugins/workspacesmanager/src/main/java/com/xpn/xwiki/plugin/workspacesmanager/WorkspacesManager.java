...
import com.xpn.xwiki.plugin.workspacesmanager.apps.activities.DefaultWorkspacesActivityStream;  
import com.xpn.xwiki.plugin.workspacesmanager.apps.activities.WorkspaceActivityStream;
...
public class WorkspacesManager extends SpaceManagerImpl
{
    ...
    /**
     * A reference to the activity stream.
     */
    private WorkspaceActivityStream workspacesActivityStream;

    private WorkspaceApplicationManager workspaceAppsManager;

    /**
     * Constructor of this Workspaces Manager.
     * 
    ...
    public WorkspacesManager(String name, String className, XWikiContext context)
    {
        ...
        workspaceAppsManager = new DefaultWorkspaceApplicationManager();
        setWorkspacesActivityStream(DefaultWorkspacesActivityStream.getInstance());
    }
    ...
    /**
     * Set the activity stream instance to use to add/retrieve events.
     * 
     * @param was the activity stream to use.
     */
    public void setWorkspacesActivityStream(WorkspaceActivityStream was)
    {
        this.workspacesActivityStream = was;
    }
    
    /**
     * @returns the activity stream instance to use to add/retrieve events
     */
    protected WorkspaceActivityStream getWorkspaceActivityStream()
    {
        return this.workspacesActivityStream;
    }
        ...
        throws SpaceManagerException
    {
        try {
            ...
            if (this.isMemberOfGroup(username, getWriterGroup(spaceName), context)) {
                ...
                previousGroup = getWriterRole();
            }
            // Actually adds it as an admin
            super.addAdmin(spaceName, username, context);
            // publish activity event about this.
            this.getWorkspaceActivityStream()
                .addWorkspaceMemberActivityEvent(spaceName, username, previousGroup, "admin", context);
     ...
     */
    public void addReader(String spaceName, String userName, boolean allowDowngrade, XWikiContext context)
        throws WorkspacesManagerException
    {
        String previousGroup = null;
        try {
            ...
            if (doAdd) {
                ...
                this.getWorkspaceActivityStream().addWorkspaceMemberActivityEvent(spaceName, userName, previousGroup,
                    getReaderRole(), context);
            } else {
                throw new WorkspacesManagerException(WorkspacesManagerException.MODULE_PLUGIN_XWS,
        ...
        throws WorkspacesManagerException
    {
        try {
            ...
            this.removeMember(spaceName, userName, context);
            this.getWorkspaceActivityStream()
                .addWorkspaceMemberActivityEvent(spaceName, userName, "admin", null, context);
        } catch (XWikiException e) {
            throw new WorkspacesManagerException(e);
        }
    }
        ...
        throws WorkspacesManagerException
    {
        try {
            ...
            this.removeMember(spaceName, userName, context);
            this.getWorkspaceActivityStream()
                .addWorkspaceMemberActivityEvent(spaceName, userName, getReaderRole(), null, context);
        } catch (XWikiException e) {
            throw new WorkspacesManagerException(e);
        }
    }
        ...
        throws WorkspacesManagerException
    {
        try {
            ...
            this.removeMember(spaceName, userName, context);
            this.getWorkspaceActivityStream()
                .addWorkspaceMemberActivityEvent(spaceName, userName, getWriterRole(), null, context);
        } catch (XWikiException e) {
            throw new WorkspacesManagerException(e);
        }
    }
        ...
        XWikiContext context) throws WorkspacesManagerException
    {
        ...
        try {
            ...
            if (doAdd) {
                ...
                this.getWorkspaceActivityStream().addWorkspaceMemberActivityEvent(spaceName, userName, previousGroup,
                    getWriterRole(), context);
            } else {
                throw new WorkspacesManagerException(WorkspacesManagerException.MODULE_PLUGIN_XWS,
                    WorkspacesManagerException.ERROR_XWSMGR_DOWNGRADENOTALLOWED, "Downgrade of user role not allowed");
            }
        } catch (XWikiException e) {
            throw new WorkspacesManagerException(e);
        }
        ...
        XWikiContext context) throws WorkspacesManagerException
    {
        ...
        String hql =
            "select userdoc.fullName from XWikiDocument as userdoc, BaseObject as userobj where"
                + " userdoc.space='XWiki' and userobj.name=userdoc.fullName and userobj.className='XWiki.XWikiUsers'"
        ...
        int startAt, XWikiContext context) throws WorkspacesManagerException
    {
        ...
        String hql =
            "select userdoc.fullName from XWikiDocument as userdoc, BaseObject as userobj, StringProperty as firstname,"
                + "StringProperty as lastname where userdoc.space='XWiki' and userobj.name=userdoc.fullName and userobj.className='XWiki.XWikiUsers'"
        ...
        XWikiContext context) throws WorkspacesManagerException
    {
        ...
        String whereSql =
            " and groupDoc.name='MemberGroup' and groupDoc.fullName=groupObj.name and groupObj.className = 'XWiki.XWikiGroups'"
                ...
                + userName
                + "' and groupDoc.space=doc.space and workspace.name=doc.fullName and workspace.className="
                + "'"
        ...
        throws SpaceManagerException
    {
        ...
        String sql =
            "select distinct doc.space, doc.creationDate from XWikiDocument as doc, BaseObject as obj, StringProperty as typeprop"
                + " where doc.fullName=obj.name and obj.className = '"
                + getSpaceClassName()
    ...
    {
        String from = "";
        String where = "and doc.space = '" + web + "'";
        List result = super.searchSpaces(from, where, 1, 0, context);
        if (result.size() == 1)
            return (Space) result.get(0);
        return null;
        ...
        int startAt, XWikiContext context) throws WorkspacesManagerException
    {
        ...
        if (!applicationName.equals(""))
            ...
            query =
                "where doc.space='" + getApplicationWeb(spaceName, applicationName)
            ...
            query = "where doc.space='" + spaceName + " and doc.name='WebHome'";
        try {
