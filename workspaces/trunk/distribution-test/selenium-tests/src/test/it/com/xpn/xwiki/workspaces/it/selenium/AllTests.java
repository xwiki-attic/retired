...
public class AllTests extends TestCase
{
    ...
    public static Test suite() throws Exception
    {
        ...
        addTestCase(suite, SpaceLifecycleTest.class);
        addTestCase(suite, SpaceDashboardTest.class);
        addTestCase(suite, SpaceRightsTest.class);
        addTestCase(suite, GlobalRolesManagementTest.class);
        addTestCase(suite, SpaceApplicationsTest.class);
        addTestCase(suite, GlobalAdministrationTest.class);
