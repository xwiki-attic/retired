...
public class WorkspacesSkinExecutor extends AlbatrossSkinExecutor implements SkinExecutor
{
    ...
    /**
     * Overrides {@link com.xpn.xwiki.it.selenium.framework.AlbatrossSkinExecutor#isAuthenticated()} to test if the user
     * is authenticated in XWS
     */
    ...
    /**
     * Overrides {@link com.xpn.xwiki.it.selenium.framework.AlbatrossSkinExecutor#logout()} to logout from XWS
     */
    public void logout()
    {
    ...
    /**
     * Overrides {@link com.xpn.xwiki.it.selenium.framework.AlbatrossSkinExecutor#login(String, String, boolean)} to
     * login into workspaces.
     */
