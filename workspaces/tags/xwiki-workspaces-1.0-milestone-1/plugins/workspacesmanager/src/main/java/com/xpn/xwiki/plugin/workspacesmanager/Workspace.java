...
public class Workspace extends SpaceImpl
{
	...
	public Workspace(String spaceName, String spaceTitle, boolean create, SpaceManagerImpl manager, XWikiContext context) throws SpaceManagerException {
	...
	public void updateSpaceFromRequest() throws SpaceManagerException {
        ...
        try {
        	...
        	// add Workspace own object...
       	 	doc.updateObjectFromRequest(((WorkspacesManagerExtension)manager.getSpaceManagerExtension()).getWorkspaceSpaceClassName(), context);
    ...
    public void setAccessLevel(String level) {
        getDoc().setStringValue(((WorkspacesManagerExtension)manager.getSpaceManagerExtension()).getWorkspaceSpaceClassName(), WORKSPACE_ACCESSLEVEL, level);
    }
	
    public String getAccessLevel() {
        return getDoc().getStringValue(((WorkspacesManagerExtension)manager.getSpaceManagerExtension()).getWorkspaceSpaceClassName(), WORKSPACE_ACCESSLEVEL);
    }
}