...
public class WorkspacesManagerTest extends AbstractWorkspacesTest
{
    ...
    private XWikiRequest createWorkspaceHTTPRequest(String spaceName, String spaceType)
    {
        ...
        params.put("XWiki.SpaceClass_0_displayTitle", spaceName);
        params.put("XWiki.SpaceClass_0_description", "Some space description");
        params.put("XWiki.WorkspaceSpaceClass_0_accesslevel", "private");
        params.put("XWiki.WorkspaceSpaceClass_0_spacetype", spaceType);
