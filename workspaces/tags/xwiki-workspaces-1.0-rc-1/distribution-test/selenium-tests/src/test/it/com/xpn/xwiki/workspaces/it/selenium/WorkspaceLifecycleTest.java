 ...
 * @version $Id$
 */
public class WorkspaceLifecycleTest extends AbstractWorkspacesTest
{
    public static Test suite()
    {
        XWikiTestSuite suite = new XWikiTestSuite("Verify workspaces lifecycle");
        suite.addTestSuite(WorkspaceLifecycleTest.class, WorkspacesSkinExecutor.class);
        return suite;
    }

    public void testCreateSpace()
    {
        createWorkspace("My Space Name", "My Space Description", false);
