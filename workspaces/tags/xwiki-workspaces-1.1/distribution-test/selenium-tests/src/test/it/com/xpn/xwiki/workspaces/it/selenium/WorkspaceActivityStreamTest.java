...
/**
 * Verify the activity stream of a workspace
 * 
 * @version $Id$
 */
public class WorkspaceActivityStreamTest extends AbstractWorkspacesTest
{
    public static Test suite()
    {
        XWikiTestSuite suite = new XWikiTestSuite("Verify workspaces activity stream");
        suite.addTestSuite(WorkspaceActivityStreamTest.class, WorkspacesSkinExecutor.class);
        return suite;
    }
    ...
    public void testWikiApplicationEvents()
    {
        ...
        openOrganizationWorkspaceHome();
        assertTextPresent("Administrator created the wiki page A test page");
        ...
        openOrganizationWorkspaceHome();
        assertTextPresent("Administrator modified the wiki page WelcomeOnThisWiki");
        ...
        assertTextPresent("Administrator deleted the wiki page WelcomeOnThisWiki");
    }
    ...
    {        
        ...
        //typeInWysiwyg("Hello, world");
        clickEditSaveAndView();
    
        openOrganizationWorkspaceHome();
        assertTextPresent("Administrator published the blog post A test blog post");
        ...
        // check the event on the workspace home
        openOrganizationWorkspaceHome();
        assertTextPresent("Administrator modified the blog post A test blog post");
        ...
        clickLinkWithLocator("//input[@value='yes']");
        clickLinkWithLocator("link=Home");
        assertTextPresent("Administrator deleted the blog post A test blog post");
