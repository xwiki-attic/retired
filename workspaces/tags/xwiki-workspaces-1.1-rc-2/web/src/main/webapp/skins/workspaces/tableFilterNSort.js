...
/*    Version: 1.5
    ...
    var image_path = "";
    var image_up = "/xwiki/skins/albatross/icons/table/arrow-up.gif";
    var image_down = "/xwiki/skins/albatross/icons/table/arrow-down.gif";
    var image_none = "/xwiki/skins/albatross/icons/table/arrow-none.gif";
...
=====================================================*/
{
    ...
    for (var i = 0 ; i < tableBodies.length ; i++) {
        ...
        for (var j = getHeaderRow(table); j < endAlternation ; j++) {
