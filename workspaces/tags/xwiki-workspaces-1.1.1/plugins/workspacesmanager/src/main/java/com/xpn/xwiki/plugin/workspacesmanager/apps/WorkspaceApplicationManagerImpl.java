 ...
 * @version $Id$
 */
public class WorkspaceApplicationManagerImpl implements WorkspaceApplicationManager
{
    /**
     * Log object to log messages in this class.
     */
    private static final Log LOG = LogFactory.getLog(WorkspaceApplicationManagerImpl.class);
