...
public abstract class AbstractWorkspacesTest extends AbstractXWikiComponentTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        RightsManagerPlugin rightManagerPlugin =
            new RightsManagerPlugin("rightsmanager", RightsManagerPlugin.class.getName(), context);
        ...
        pluginNames.add("rightsmanager");

        this.mockPluginManager = mock(XWikiPluginManager.class);
        this.mockPluginManager.stubs().method("getPlugin").with(eq("rightsmanager")).will(
            returnValue(rightManagerPlugin));

        this.mockPluginManager.stubs().method("getPlugin").with(not(eq("rightsmanager"))).will(
