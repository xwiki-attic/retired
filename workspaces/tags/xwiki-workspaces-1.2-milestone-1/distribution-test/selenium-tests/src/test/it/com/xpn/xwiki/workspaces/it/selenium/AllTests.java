...
public class AllTests extends TestCase
{
    ...
    public static Test suite() throws Exception
    {
        ...
        addTestCase(suite, WorkspaceLifecycleTest.class);
        addTestCase(suite, WorkspaceActivityStreamTest.class);
        addTestCase(suite, WorkspaceRightsTest.class);
        addTestCase(suite, GlobalMembersGroupsManagementTest.class);
	addTestCase(suite, WorkspacesApplicationManagementTest.class);
