 ...
 * @version $Id$
 */
public class WorkspacesApplicationManagementTest extends AbstractWorkspacesTest
{

    public static Test suite()
    {
        XWikiTestSuite suite = new XWikiTestSuite("Verify workspaces members management");
        suite.addTestSuite(WorkspacesApplicationManagementTest.class, WorkspacesSkinExecutor.class);
        return suite;
    }
    ...
    protected void setUp() throws Exception
    {
        ...
        if (!getSelenium().isTextPresent("something")) {
            // Create a new application that doesn't have installed any application
            List<String> applicationNames = new LinkedList();
            applicationNames.add("application_Blog");
            applicationNames.add("application_Files");
            applicationNames.add("application_Photos");
            applicationNames.add("application_Wiki");
            applicationNames.add("application_Stream");
            this.createWorkspace("something", "something more", "public", applicationNames);
        }
    }
    ...
    {
        this.installApplication("something", "Blog");
        ...
        this.uninstallApplication("something", "Blog");
     ...
     * </ul>
     */
    public void testWorkStream()
    {
        this.installApplication("something", "Stream");
        ...
        clickLinkWithXPath("//span[@class='userpicture']/a[@href='/xwiki/bin/view/Space_something_Stream/?uid=XWiki.Admin']");

        this.uninstallApplication("something", "Stream");
    }
     ...
     * </ul>
     */
    public void testWikiApp()
    {
        this.installApplication("something", "Wiki");
        assertElementPresent("//a[text()='Wiki']");
        clickLinkWithXPath("//a[@href='/xwiki/bin/view/Space_something_Wiki/']");
        ...
        open("/xwiki/bin/view/Space_something_Wiki/MyFirstWikiPage");
        ...
        this.uninstallApplication("something", "Wiki");
